...
class StickyNoteItem(QGraphicsItem):
    ...
    # 1. Change note shadow on mouse hover events.
    ...
    # 2. Delete the note on the Delete key press events.
    ...
    # 3. Lock/unlock the note on mouse press events.
    ...
    def paint(self, painter, option, widget):
        ...
        # 4. Update paint() to draw the lock icon.
