...
class Window(QWidget):
    ...
    def __init__(self):
        ...
        # 3. Simulate a joint bank account
    ...
    def start_threads(self):
        ...
        self.bank_account = BankAccount(
            self.thread_count * self.amount)
        self.bank_account_thread = QThread()
        self.bank_account_thread.setObjectName(
            'Bank account thread')
        self.bank_account.moveToThread(
            self.bank_account_thread)
    ...
    def on_worker_done(self):
        ...
        if self.completed == self.thread_count:
            ...
            self.label.setText('Final balance: ' +
                str(self.bank_account.balance))
